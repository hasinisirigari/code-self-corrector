...
## Error Distribution (HumanEval 100)
...
2. **Lower baseline = more room to improve**
3. **Weaker models benefit more** - 7B improved 16.7%, 70B improved 0%
4. **LOGIC errors dominate** but are hardest to fix
5. **NAME errors are most fixable** at 33.3%

## Future Work

- Include expected vs actual output in repair prompts (implemented)
